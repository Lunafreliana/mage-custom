...
/** Triggers when a planeswalk operation moves away from this planar object. */
public class PlaneswalkAwayFromSourceTriggeredAbility extends TriggeredAbilityImpl {
    ...
    protected PlaneswalkAwayFromSourceTriggeredAbility(final PlaneswalkAwayFromSourceTriggeredAbility ability) {
        super(ability);
    }
