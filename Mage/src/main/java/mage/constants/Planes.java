...
public enum Planes {
    ...
    PLANE_MULTIVERSAL_HIGH_COUNCIL("MultiversalHighCouncilPlane", "Plane - Multiversal High Council", "PUNK"),
    ...
    PLANE_OROCHI_COLONY("OrochiColonyPlane", "Plane - Orochi Colony", "MOC"),
    ...
    PLANE_STRONGHOLD_FURNACE("StrongholdFurnacePlane", "Plane - Stronghold Furnace", "MOC"),
    ...
    PLANE_WELCOME_TO_VALLEY("WelcomeToValleyPlane", "Plane - Welcome to Valley", "PUNK"),
